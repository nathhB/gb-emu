...
draw_pixel :: proc(ppu: ^PPU, mem: ^GB_Memory, x: int, y: int) {
    if x > 159 {
        return
    }
...
get_pixel_color :: proc(ppu: ^PPU, mem: ^GB_Memory, tile_id: u8, x: int, y: int) -> u32 {
    // a tile is 16 bytes
...
get_tile_addr :: proc(mem: ^GB_Memory, tile_id: u8) -> u16 {
    // https://gbdev.io/pandocs/Tile_Data.html
